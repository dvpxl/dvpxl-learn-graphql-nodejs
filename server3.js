 ...
 */
 ...
 type Mutation {
     changeDocumentName(id: Int!, name: String!): Document
 }
...
// see that here, passed in as object
var changeDocumentName = function({id, name}) {
    documentData.map(doc => {
     ...
     // confirm object in array mutated (ok)
     console.log(documentData)

     return documentData.filter(doc => doc.id === id)[0]
}
